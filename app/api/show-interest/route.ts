      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; color: #333;">
          <div style="background: linear-gradient(135deg, #166534, #15803d); padding: 20px 24px; border-radius: 8px 8px 0 0;">
            <h1 style="color: white; margin: 0; font-size: 20px;">New Student Interest — NS Academy</h1>
            <p style="color: #bbf7d0; margin: 8px 0 0; font-size: 14px;">Someone wants to enroll in CA Final SFM</p>
          </div>
          ...
          <div style="background: #fef9c3; border-left: 4px solid #ca8a04; padding: 14px 20px;">
            ...
            <p style="margin: 6px 0 0; font-size: 13px; color: #713f12;">
              WhatsApp this student: <a href="https://wa.me/91${phone}?text=Hi%20${encodeURIComponent(name)}%2C%20I%27m%20CA%20Nikesh%20Shah.%20Thank%20you%20for%20your%20interest%20in%20the%20CA%20Final%20SFM%20course!%20Let%20me%20share%20the%20enrollment%20details%20with%20you."
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; color: #333;">
          ...
          <div style="padding: 24px; background: white;">
            ...
            <p style="font-size: 15px; line-height: 1.6; color: #374151;">
              Thank you for your interest in the <strong>CA Final Strategic Financial Management</strong> course by CA Nikesh Shah.
            </p>
            <p style="font-size: 15px; line-height: 1.6; color: #374151;">
              We have received your details and will reach out to you personally on <strong>+91 ${phone}</strong> within a few hours to guide you through the enrollment process.
            </p>

            <div style="background: #f0fdf4; border-radius: 12px; padding: 20px; margin: 20px 0;">
              <strong style="color: #166534; display: block; margin-bottom: 8px;">While you wait:</strong>
              <p style="margin: 0; font-size: 14px; color: #374151;">
                Watch the <strong>Free Preview Lecture</strong> on our website to experience CA Nikesh Shah's logic-first teaching style before enrolling.
              </p>
            </div>
